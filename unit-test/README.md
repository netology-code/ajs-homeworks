...
3. Jest должен обеспечивать покрытие 100 % по строкам для тестируемых функций.
...
Сгенерируйте проект на базе `npm`. Подключите туда `jest` и напишите автотесты, которые обеспечивают покрытие 100 % для вашей функции по строкам.
