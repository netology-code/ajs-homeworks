...
Создайте в корне проекта файл `test-browser.html`:
...
В браузере откройте `http://localhost:8080/test-browser.html`. Вы должны увидеть:
...
1. Работающий `test-browser.html`, открываемый через `http-server`
